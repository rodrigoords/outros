...
public class ContratoMultiparcelado extends Contrato implements CalculoMultaParcela{

	public ContratoMultiparcelado(Cliente cliente, Gerente gerente, LocalDate dataInicio, LocalDate dataFim,
			BigDecimal valor) {
